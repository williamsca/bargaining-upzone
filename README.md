...
# Abstract
> This paper estimates the incidence of development impact fees on the welfare of households, owners of developed land, and owners of undeveloped land using quasi-random variation in county impact fees in Virginia. I develop a dynamic spatial equilibrium model that features imperfectly mobile households and an urban growth process. Households can be inframarginal in their location choices due to differences in idiosyncratic location-specific preferences. I use the reduced-form effects of impact fee changes to identify and estimate incidence. I find that impact fees are born primarily by households and owners of undeveloped land rather than owners of already developed land. My results provide an economic basis for the persistent local popularity of impact fees and tendency for state legislatures and courts -- who are more likely to represent the interests of households -- to regulate and restrict them.
