...
Given that $H_i^S = V_i$ under Leontief production, the supply of new housing is then

$$H_i^S = (B_i^H(r - c - \tau))^{\eta_i} + H_i^F$$

where $r$ is the rental rate of housing and $c$ is the unit cost of materials.
...
# Simulations
To simplify the presentation, I assume there are only two locations $c \in \{i,j\}$. 
